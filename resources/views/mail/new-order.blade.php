@php use App\Enums\Product\Media; @endphp
...
<head>
    ...
    <title>Підтвердження замовлення</title><!--[if (mso 16)]>
    <style type="text/css">
        a {
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-m-txt-c"
                                                                style="padding:0;Margin:0;padding-bottom:10px"><h1
                                                                    style="Margin:0;line-height:46px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:26px;font-style:normal;font-weight:bold;color:#333333">
                                                                    Підтвердження замовлення</h1></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" class="es-m-p0r es-m-p0l"
                                                                style="Margin:0;padding-bottom:20px;padding-left:40px;padding-right:40px">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    Шановний {{$order->name}} {{$order->surname}},
                                                                    <br>
                                                                    Дякуємо за ваше замовлення на <a target="_blank"
                                                                                                     style="color: blue"
                                                        ...
                                                        <tr>
                                                            <td align="left" class="es-m-p0r es-m-p0l"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    ...
                                                                    <br>
                                                                    <strong>Спосіб
                                                                        доставки:</strong> {{$order->delivery_type_text}}
                                                                    <br>
                                                                    <strong>Спосіб
                                                                        оплати:</strong> {{$order->payment_type_text}}
                                                                    <br>
                                                                    @if($order->city_name)
                                                                        <strong>Місто:</strong> {{$order->city_name}}
                                                                        <br>
                                                                    @endif
                                                                    @if($order->warehouse_name)
                                                                        <strong>Відділення:</strong> {{$order->warehouse_name}}
                                                                        <br>
                                                                    @endif
                                                                    <strong>Вартість:</strong> {{ $order->total_price_usd }}
                                                                    $ / {{ $order->total_price_uah }} грн.
                                                                    <br>
                                                                    @if($order->discount_percent > 0)
                                                                        <strong>Знижка ({{ $order->discount_percent }}
                                                                            %)</strong> {{ $order->discount_usd }} $
                                                                        / {{$order->discount_uah}} грн.
                                                                        <br>
                                                                        <strong>Вартість зі
                                                                            знижкою: </strong> {{ round($order->total_price_usd - $order->discount_usd, 2) }}
                                                                        $
                                                                        / {{ round($order->total_price_uah - $order->discount_uah)}}
                                                                        грн.
                                                                        <br>
                                                                    @endif
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0"><span
                                                                    ...
                                                                    style="border-style:solid;border-color:black;background:black;border-width:2px;display:inline-block;border-radius:6px;width:auto"><a
                                                                        href="https://keyscover.store/orders/list"
                                                                        class="es-button" target="_blank"
                                                                        style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;padding:10px 30px 10px 30px;display:inline-block;background:black;border-radius:6px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid black;padding-left:30px;padding-right:30px">ІСТОРІЯ ЗАМОВЛЕНЬ</a></span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tr>
                                                            <td align="left" class="es-m-txt-l"
                                                                style="padding:0;Margin:0"><h2
                                                                    style="Margin:0;line-height:31.2px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:26px;font-style:normal;font-weight:bold;color:#333333">
                                                                    Замовлені товари</h2></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                                        ...
                                                                        <tr>
                                                                            <td align="left"
                                                                                ...
                                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                    Арт. {{$orderProduct->product->sku}}</p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                                        ...
                                                                        <tr>
                                                                            <td align="right"
                                                                                style="padding:0;Margin:0"><p
                                                                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                    <strong>{{$orderProduct->product->price}}
                                                                                        $
                                                                                        / {{ceil($orderProduct->product->uah_price)}}
                                                                                        грн.</strong></p></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="right" class="es-m-txt-r"
                                                                style="padding:0;Margin:0;padding-top:15px"><h3
                                                                    ...
                                                                    Вартість:&nbsp;<strong>{{$order->total_price_usd}} $
                                                                        / {{$order->total_price_uah }} грн.</strong>
                                                                </h3></td>
                                                        </tr>
                                                    </table>
                                                </td>
