...
<head>
    ...
    <title>{{$productSubscription->product->name}} знову в наявності</title><!--[if (mso 16)]>
    <style type="text/css">
        a {
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-m-p0r es-m-p0l"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    Шановний {{$productSubscription->user->full_name}},
                                                                    <br>
                                                                    Повідомляємо, що "<a
                                                                        target="_blank"
                                                                        style="color: blue"
                                                                        href="https://keyscover.store/product/{{$productSubscription->product_id}}">{{$productSubscription->product->name}}</a>"
                                                                    який ви очікували знову доступний для замовлення. Ви
                                                                    можете оформити ваше замовлення в декілька кліків на
                                                                    <a target="_blank"
                                                                       style="color: blue"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            ...
                                                                            @php
                                                                                $image = $productSubscription->product->getFirstMediaUrl(Media::COLLECTION_IMAGES->value, 'watermarked');
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left"
                                                                            ...
                                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                Арт. {{$productSubscription->product->sku}}</p>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                                    ...
                                                                    <tr>
                                                                        <td align="right"
                                                                            style="padding:0;Margin:0"><p
                                                                                style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                <strong>{{$productSubscription->product->price}}
                                                                                    $
                                                                                    / {{$productSubscription->product->uah_price}}
                                                                                    грн.</strong></p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
